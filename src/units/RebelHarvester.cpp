...
RebelHarvester::~RebelHarvester() = default;

void RebelHarvester::save(OutputStream& stream) const
{
...
void RebelHarvester::blitToScreen()
{
...
void RebelHarvester::deploy(const Coord& newLocation)
{
...
void RebelHarvester::drawSelectionBox()
{
...
void RebelHarvester::setAmountOfSpice(FixPoint newSpice)
{
...
void RebelHarvester::setDestination(int newX, int newY)
{
...
void RebelHarvester::setTarget(const ObjectBase* newTarget)
{
...
void RebelHarvester::setReturned()
{
...
bool RebelHarvester::isHarvesting() const {
...
bool RebelHarvester::canAttack(const ObjectBase* object) const
{
...
void RebelHarvester::playAttackSound()
{
    soundPlayer->playSoundAt(Sound_ExplosionSmall, location);
}

FixPoint RebelHarvester::extractSpice(FixPoint extractionSpeed)
{
