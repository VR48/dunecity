...
EliteSiegeTank::EliteSiegeTank(House* newOwner) : TankBase(newOwner) {
    EliteSiegeTank::init();

    setHealth(getMaxHealth());
}

EliteSiegeTank::EliteSiegeTank(InputStream& stream) : TankBase(stream) {
    EliteSiegeTank::init();
}

void EliteSiegeTank::init() {
    itemID = Unit_EliteSiegeTank;
...
EliteSiegeTank::~EliteSiegeTank() = default;

void EliteSiegeTank::blitToScreen() {
...
void EliteSiegeTank::playAttackSound() {
