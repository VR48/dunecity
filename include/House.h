...
public:
    ...
    */
    ...
    /**
        Check the appropriate house limit for a specific unit type.
        \return true if creating itemID would exceed its unit category limit
    */
    bool isUnitLimitReached(int itemID) const;
